"""
Beautiful console output utilities for KGen.
...
class KGenConsole:
    """Beautiful console interface for KGen operations."""
    ...
    def print_banner(self):
        """Print the KGen banner with elegant styling."""
        banner_text = Text()
        banner_text.append("KGen", style="bold bright_cyan")
...
def print_welcome_message(agent_type: str = "video"):
    ...
    welcome_messages = {
        "video": "Welcome to KGen Video Agent - Transform your ideas into stunning videos!",
        "poetry": "Welcome to KGen Poetry Agent - Process and visualize Chinese poetry with AI!"
    }
