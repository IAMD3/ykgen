"""
KGen - AI-powered story and video generation.
...
__version__ = "0.1.0"
__author__ = "KGen Team"

# Core modules (staying in root)
from kgen.config.config import Config, config
from kgen.model.models import Character, Characters, Scene, SceneList, VisionState
...
from kgen.lora.lora_selector import LoRASelector, select_loras_for_scenes, select_loras_for_all_scenes_optimized
from .console import (
    console,
    print_banner,
    print_characters,
